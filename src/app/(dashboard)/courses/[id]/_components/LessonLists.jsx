...
const LessonLists = ({ lessons, courseId }) => {
  ...
  const handleDelete = async e => {
    ...
    try {
      const response = await deleteLesson(lessonId, courseId)
                ...
                <TableRow key={lesson?.id}>
                  ...
                  <TableCell align='center'>
                    <Stack direction='row' spacing={1} alignItems='center' justifyContent='center'>
                      <IconButton component={Link} href={`/courses/${courseId}/lessons/${lesson?.id}`}>
                        <i className='ri-eye-fill'></i>
                      </IconButton>
                      <IconButton component={Link} href={`/courses/${courseId}/lessons/${lesson?.id}/update`}>
