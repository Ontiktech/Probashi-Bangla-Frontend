...
const DayList = ({ days, courseId, lessonId }) => {
  ...
  const handleDelete = async e => {
    ...
    try {
      const response = await deleteDay(dayId, courseId, lessonId)
                ...
                <TableRow key={day?.id}>
                  ...
                  <TableCell align='center'>
                    <Stack direction='row' spacing={1} alignItems='center' justifyContent='center'>
                      <IconButton component={Link} href={`/courses/${courseId}/lessons/${lessonId}/days/${day?.id}`}>
                        <i className='ri-eye-fill'></i>
                      </IconButton>
                      <IconButton
                        component={Link}
                        href={`/courses/${courseId}/lessons/${lessonId}/days/${day?.id}/update`}
                      >
